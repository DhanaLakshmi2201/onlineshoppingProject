...
public class HomeController {
    ...
    public void addcustomers(){
        ...
        shoppingCart.add_customer(new Customer("ramya","12457854",new Basket()));
        shoppingCart.add_customer(new Customer("ammu","87417854",new Basket()));
        shoppingCart.add_customer(new Customer("thara","958417854",new Basket()));
    }
